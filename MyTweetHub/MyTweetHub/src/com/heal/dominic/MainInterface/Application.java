...
public class Application extends LoginGUI implements Runnable {
	...
	public static Runnable TimeLine() throws IllegalStateException,
		...
		Splash.loadingResourcelbl.setText("Loading Resources... UserTimeline");
		Splash.loadingResourcelbl.repaint();
	...
	public static Runnable userTimeLine() throws IllegalStateException,
			TwitterException {
		twitter = getTwitter();
		...
		Splash.loadingResourcelbl.setText("Loading Resources... UserTimeline");
		Splash.progressBar.setValue(Splash.splashCounter+20);
