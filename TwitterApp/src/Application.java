...
public class Application extends TwitterAppGui {
	...
	public static void TimeLine() throws IllegalStateException, MalformedURLException, TwitterException{
		...
		mntmGetInfo.setIcon(new ImageIcon(Application.class.getResource("Note-Add_hover.png")));
		...
		mntmGetInfo.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				if (e.getSource() instanceof JMenuItem) {
					...
					{
						mntmGetInfo.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(Application.class.getResource("Note-Add.png"))));
					}
					else
					{
						mntmGetInfo.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(Application.class.getResource("Note-Add_hover.png"))));
					}
				}
			}
		});
		...
		mntmRetweet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					statusArr[row] = "<html><font color=green><b>" + statusList.get(row).getUser().getName() + ": " + "</b>" + statusList.get(row).getText() + "</font>  </html>";
		...
		mntmFavourite.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					statusArr[row] = "<html><font color=orange><b>" + statusList.get(row).getUser().getName() + ": " + "</b>" + statusList.get(row).getText() + "</font>  </html>";
					dlm.set(row, new ListEntry(statusArr[row], new ImageIcon (profileimages[row])));
				} catch (TwitterException e1) {
		...
		mntmFavourite.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				if (e.getSource() instanceof JMenuItem) {
					...
					{
						mntmFavourite.setIcon(new ImageIcon(Application.class.getResource("favorite_on.png")));
					}
					else
					{
						mntmFavourite.setIcon(new ImageIcon(Application.class.getResource("favorite_hover.png")));
					}
				}
		...
		mntmClose.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				if (e.getSource() instanceof JMenuItem) {
					...
					{
						mntmClose.setIcon(new ImageIcon(Application.class.getResource("dialog_cancel.png")));
					}
					else
					{
						mntmClose.setIcon(new ImageIcon(Application.class.getResource("dialog_close.png")));
					}
				}
	...
	public static void Trending() {
		try {
			...
			trendingList.addMouseMotionListener(new MouseAdapter() {
				public void mouseMoved(MouseEvent me) {
					Point p = new Point(me.getX(),me.getY());
					trendingList.setSelectedIndex(trendingList.locationToIndex(p));
					}
			});
	 ...
	 */
	public Application() throws TwitterException, ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		lblHomebutton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (CardCounter % 2 == 0){
					lblNewLabel.setIcon(new ImageIcon(getClass().getResource("/Statistics_panel_friends.png")));
				}
				else {
					lblNewLabel.setIcon(new ImageIcon(getClass().getResource("/Statistics_panel_new.png")));
				}
				CardCounter++;
			}
		});
		...
		panel_Trending.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		...
		lblTrendingBg.setIcon(new ImageIcon(getClass().getResource("/Trending_panel.png")));
		panel_4.add(lblTrendingBg);

		JButton BtnToggleTimeline = new JButton("Switch Timeline");
		BtnToggleTimeline.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		...
		AudioInputStream audioInputStream;
		try {
			audioInputStream = AudioSystem.getAudioInputStream(getClass().getResource("/pad_confirm.wav"));
			Clip clip = AudioSystem.getClip();
			clip.open(audioInputStream);
			clip.start();
		} catch (UnsupportedAudioFileException e) {
